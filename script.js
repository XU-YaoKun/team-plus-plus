...
function createTeam() {
  ...
  while (!valid && (teamName != null && teamName != "")) {
    teamName = prompt(
      "Team name already taken, please enter another team name."
    );
  }
...
function modifyAdmin() {
  var person = prompt(
    "Please enter the email of the user of the future admin",
    "Gary"
  );
  var valid = false;
...
function removeMember() {
  var person = prompt(
    "Please enter the email of the user that you want to remove",
    "Gary"
  );
  var valid = false;
  //TODO check if person exist in team
